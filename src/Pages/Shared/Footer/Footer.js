...
<div className="items-center grid-flow-col">
  ...
  <div className='justify-items-center'>
    ...
    <Link className="link no-underline">Branding</Link> 
    <Link className="link no-underline ">Design</Link> 
    <Link className="link no-underline">Marketing</Link> 
    <Link className="link no-underline">Advertisement</Link>
  </div> 
  <div className='justify-items-center'>
    <span className="footer-title">Company</span> 
    <Link className="link no-underline">About us</Link> 
    <Link className="link no-underline">Contact</Link> 
    <Link className="link no-underline">Jobs</Link> 
